...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" action="login.php" onsubmit="return validate_form(this)" method="post">
       ...
       <div class="login-wrap">
         ...
         <label class="checkbox">
                ...
                <span class="pull-right"> <a href="reset/enter_email.php"> Forgot Password?</a></span>
         </label>
